...
{
    public partial class StationCYContext : DbContext
    {
        public StationCYContext()
        {
        }

        public StationCYContext(DbContextOptions<StationCYContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AspNetUsers>(entity =>
            {
                ...
                entity.Property(e => e.MembershipDateEnd).HasColumnType("datetime");

                entity.Property(e => e.MembershipDateStart).HasColumnType("datetime");
                ...
                entity.HasOne(d => d.MembershipType)
                    ...
                    .HasConstraintName("FK_AspNetUsers_MembershipType");
            });
