...
namespace MVCManukauTech
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //CRC 29/3/20 Reference from https://www.reflectionit.nl/blog/2017/paging-in-asp-net-core-mvc-and-entityframework-core
            services.AddMvc();

            //Rename to user database name
            services.AddDbContext<StationCYContext>(options =>
                options.UseSqlServer(
                Configuration.GetConnectionString("DefaultConnection")));
